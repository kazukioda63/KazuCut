...
| 9 | 500ms削除 | 仕様14章のテスト構成で実行 | Keep Segment2件、後半左詰め | **OK 2026-07-12**（合計77845ms=元-500ms、phase3-result.json） |
| 10 | A/V同期 | 9の後に波形確認 | ずれが1フレーム未満 | **OK 2026-07-12**（機械検証で0 tick。目視確認は推奨） |
| 11 | BGM不変 | 9の後にA2確認 | 位置・長さ完全不変 | **OK 2026-07-12**（対象外トラック指紋一致） |
